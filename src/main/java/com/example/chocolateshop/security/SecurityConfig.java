...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/orders/page/**").hasAuthority(Permission.ORDERS_WRITE.getPermission())
                .antMatchers(HttpMethod.GET,"/orders/report-1").hasAuthority(Permission.ORDERS_READ.getPermission())
                ...
                .antMatchers("/products/bucket/**").hasAuthority(Permission.BUCKET_WRITE.getPermission())
                .antMatchers("/bucket/**").hasAuthority(Permission.BUCKET_WRITE.getPermission())
